...
var FlashList = /** @class */ (function (_super) {
    ...
    FlashList.prototype.scrollToIndex = function (params) {
        ...
        if (layout && listSize) {
            ...
            var _g = getScrollCoords(), x = _g.x, y = _g.y;
            ...
            params.index + (((_d = params.viewPosition) !== null && _d !== void 0 ? _d : 0 >= 0.5) &&
                params.index !== ((_f = (_e = this.props.data) === null || _e === void 0 ? void 0 : _e.length) !== null && _f !== void 0 ? _f : -1) - 1
                ? 1
                : 0), getScrollCoords);
        }
    };
